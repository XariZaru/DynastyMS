...
--
-- Table structure for table `hwidbans`
--
...
--
-- Dumping data for table `hwidbans`
--

LOCK TABLES `hwidbans` WRITE;
/*!40000 ALTER TABLE `hwidbans` DISABLE KEYS */;
/*!40000 ALTER TABLE `hwidbans` ENABLE KEYS */;
UNLOCK TABLES;
