...
function setup(mapid) {
	...
	// Setup the Maps
	battleMap = eim.getMapFactory().getMap(106021500);
	exitMap = em.getChannelServer().getMapFactory().getMap(106021400);
...
function playerEntry(eim, player) {
    ...
    //player.announce(Packages.tools.MaplePacketCreator.showIntro("Effect/Direction2.img/mushCatle/pepeKing" + mobType));
}
