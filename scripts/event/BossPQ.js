...
function setup() {
    exitMap = em.getChannelServer().getMapFactory().getMap(109040000);
    finishMap = em.getChannelServer().getMapFactory().getMap(109040000);
    var instanceName = "BossPQ" + instanceId;
