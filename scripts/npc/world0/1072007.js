...
/* Thief Job Instructor
	Thief's Construction Site (108000400-108000402)
	Used to turn in dark marbles for the thief second job advancement.
    @author Twdtwd
 */
    ...
    if (mode < 0)
        ...
        if (cm.getJobId() == 400 && cm.getLevel() >= 30) {
            if(cm.hasItem(4031013, 30)) {
                if(status == 0) {
                    cm.sendNext("Amazing, you've collected 30 #t4031013#s! It must have been difficult.Very well, you have passed the test. As a reward I am giving you a #b#t4031012##k. Take it with you and go back to #m103000000#.");
                } else if(status == 1) {
