...
function action(mode, type, selection) {
    ...
    if (actionx["1stJob"]){
        if (status == 0)
            ...
            cm.sendNextPrev("One more warning. Once you have chosen, you must be careful. Dying results in a huge loss in experience and we wouldn't want that to happen, would we?");
