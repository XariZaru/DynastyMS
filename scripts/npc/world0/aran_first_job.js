		...
		switch(cm.getQ()) {
		 ...
		 //<editor-fold defaultstate="collapsed" desc="Up to 27">
		     ...
		     case 22:
		         ...
		         break;
		     case 21:
		         cm.sendSimple(""+(!pers && !honor && !steal ? "These are your following attributes which distinguish you from the rest. If you'd like for me to elucidate on any of the skills you can simply ask me." : "What other skills would you like me to elucidate upon? (You need to read each selection)")+"\r\n\r\n#b#L0#Persuasion: "+cm.getPlayer().getPersuasion()+"\r\n#L1#Integrity: "+cm.getPlayer().getHonor()+"\r\n#L2#Steal: "+cm.getPlayer().getSteal()+""+(pers && honor && steal ? "\r\n#L3#I'm Good" : "")+"");
		         break;
		     //</editor-fold>
