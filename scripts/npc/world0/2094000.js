...
function action(mode, type, selection) {
	if (mode < 1) {
		...
		if (selection == 0) {
			...
			cm.sendSimple("Thank you for saving #e#b#p2094001##k#n from the #r#o9300119##k. As a reward, I will make you a #bLord Pirate Hat#k if you bring me #z"+4031551+"#. Now, exactly which hat would you like?" +
			"#b\r\n#L10#(Lv. 60) Lord Pirate's Hat\r\n#r(Need 30 #z"+4031551+"#)#k#l\r\n" +
			...
			} else if (cm.haveItem(4031551, 30)) {
			...
			if (!cm.canHold(1002572)) {
				cm.sendOk("You do not have enough space in your inventory for this hat.");
			} else if (cm.haveItem(4031551, 80) && cm.haveItem(1002571, 1)) {
				cm.gainItem(1002571, -1);
			...
			if (!cm.canHold(1002573)) {
				cm.sendOk("You do not have enough space in your inventory for this hat.");
			} else if (cm.haveItem(4031551, 200) && cm.haveItem(1002572, 1)) {
			...
			if (!cm.canHold(1002574)) {
				cm.sendOk("You do not have enough space in your inventory for this hat.");
			} else if (cm.haveItem(4031551, 350) && cm.haveItem(1002573, 1)) {
