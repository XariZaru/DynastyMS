...
var status = 0;
var maps = [104000000, 102000000, 100000000, 103000000, 120000000, 104000000, 102000000, 100000000, 103000000, 120000000];
var cost = [120, 100, 100, 120, 80, 1200, 1000, 1000, 1200, 800];
var sel = -1;
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 1) {
            if (cm.getJobId() == 0) {
                cm.sendSimple("tttWe have a special 90% discount for beginners. Choose your destination for fees will change from place to place.#b\n\
\r\n #L0# Lith Harbor (120 mesos)#l \r\n #L1# Perion (100 mesos)#l \r\n #L2# Henesys (100 mesos)#l \r\n #L3# Kerning City (120 mesos)#l \r\n #L4# Nautilus Harbor (80 mesos)#l");                
            } else {               
                cm.sendSimple("Choose your destination, for fees will change from place to place.#b\n\
\r\n #L5# Lith Harbor (1200 mesos)#l \r\n #L6# Perion (1000 mesos)#l \r\n #L7# Henesys (1000 mesos)#l \r\n #L8# Kerning City (1200 mesos)#l \r\n #L9# Nautilus Harbor (800 mesos)#l");
            }
        } else if (status == 2) {
