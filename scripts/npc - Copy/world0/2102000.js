        ...
        if (!cm.haveItem(ticket,1)) {
           ...
           switch(cm.getOrbisAriantBoatStatus()) {
            ...
            case 1:
                ...
                break;
            case 2:
           cm.sendYesNo(""+(cm.getQ()==12 ? "Ah, #h #, you are finally leaving desert place, eh? " : "")+"It looks like there's plenty of room for this ride. Please have your ticket ready so I can let you in. The ride will be long but you'll get to your destination just fine. What do you think? Do you want to get on this ride?");  
           break;
           }
    }
}
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 1) {
             if (cm.getJobId()==2000 && cm.getQ()==12) {
                 cm.warp(200000100);
