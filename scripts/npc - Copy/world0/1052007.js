...
//        text += " You will be brought in in immediately. Which ticket you would like to use?#b";
//    else
//        close = true;
...
function start() {
    cm.talkGuide("The ticket gate is out of order. There is a note taped to the machine: Speak to Bell for NLC transportation.");
    cm.dispose();
}