...
function start(){
        switch(cm.getOrbisLeafreBoatStatus()){ //NOBOAT(0), TOOLATE(1), CANBOARDBOAT(2)
            case 0:
                cm.sendOk("The boat to Leafre has already taken off, please be patient and wait for next one.");
                cm.dispose();
                break;
            case 1:
                cm.sendOk("The boat to Leafre is ready to take off, please be patient and wait for next one.");
                cm.dispose();
                break;
            case 2:
