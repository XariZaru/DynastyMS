    ...
    " even though you are here before me I'd wish to respect that code of honor.");
        ...
        if (cm.getQ()==9) {
            ...
            if (cm.countMonster() > 0) {
                ...
                cm.sendOk("That was a very well done job. You've been blessed with new powers. Congratulations. You may exit through the portal"+
                    " on the left.");
                cm.talkGuide("Oh sweet, more powers. This will allow us to train on tougher monsters!"), cm.changeJobById(cm.getJobId() + 10), 
       ...
       if (cm.getQ()==34 && cm.getMapId()==105040401) {
        ...
        if (cm.getQ()==41) {
            if (selection != 1) {
                ...
                cm.talkGuide("Wrong answer! C'mon, we rehearsed this with our agent!");
            ...
            " and munitions. If we don't act immediately, we may have to suffer major repercussions.");
                ...
                cm.warp(100000204);
                cm.completeQ(), cm.spawnDiff(100000204, 9400740, 3, 66, 161), cm.dispose();
            } else if (cm.getQ()==11) {
