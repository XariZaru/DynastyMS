...
function start(mode, type, selection) {
	...
	if (status == 0) {
		...
		qm.sendNext("Precisely. The trickery that this creature employs is nefarious in its execution. I don't want those things anywhere near New Leaf City. Thus the bounty. The requirement for this one is simple. You must bring me #b30 of those strange silver clovers#... hmm, that's sort of a mouthful- lets just call them #bLucky Charms#. When you're done, be sure to return to me!\r\n");
		qm.forceStartQuest();
		qm.dispose();
	}
}
