				...
				if (targetid != -1 && !chr.isAlive()) {
					...
					if (executeStandardPath) {
						...
						if (wheel && chr.getItemQuantity(5510000, false) > 0) {
							...
							if (chr.haveItem(4031267)) {
								MapleInventoryManipulator.removeById(c, MapleInventoryType.ETC, 4031267, 1, true, false);
								chr.dropMessage("You've automatically applied DNA Freezer to prevent your buffs from being canceled on death.");
							} else {
