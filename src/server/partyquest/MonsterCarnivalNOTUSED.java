 ...
 * 
 * I ain't hard coding this #scriptingftw - David
 */
public class MonsterCarnivalNOTUSED {
    ...
    public MonsterCarnivalNOTUSED(int room, byte channel, MonsterCarnivalParty red1, MonsterCarnivalParty blue1) {
